...
export const opencodeWorkflowAdapter: OpenCodeWorkflowAdapterContract = {
  ...
  managedFiles: [
    ...
    {
      type: "agent",
      source: "adapters/opencode/assets/explorer-agent.md",
    ...
    {
      type: "agent",
      source: "adapters/opencode/assets/planner-agent.md",
    ...
    {
      type: "agent",
      source: "adapters/opencode/assets/implementer-agent.md",
    ...
    {
      type: "agent",
      source: "adapters/opencode/assets/reviewer-agent.md",
    ...
    {
      type: "agent",
      source: "adapters/opencode/assets/tester-agent.md",
